 ...
 * \file decord/runtime/node_base.h
 ...
 */
#ifndef DECORD_RUNTIME_NODE_BASE_H_
#define DECORD_RUNTIME_NODE_BASE_H_
 ...
 * Do not call create raw Node pointer, always use decord::make_node.
 *
 * \note In most cases, please inheritate decord::Node.
...
#endif  // DECORD_RUNTIME_NODE_BASE_H_