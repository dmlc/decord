 ...
 * \file decord/runtime/module.h
 * \brief Runtime container of the functions generated by DECORD,
 *  This is used to support dynamically link, load and save
 *  functions from different convention under unified API.
 */
#ifndef DECORD_RUNTIME_MODULE_H_
#define DECORD_RUNTIME_MODULE_H_
...
/*!
 * \brief Module container of DECORD.
 */
class Module {
 public:
  Module() {}
   ...
   */
  DECORD_DLL void Import(Module other);
  /*!
   ...
   */
  DECORD_DLL static Module LoadFromFile(const std::string& file_name,
...
class ModuleNode {
 public:
   ...
   * \param format The format of the file.
   */
  DECORD_DLL virtual void SaveToFile(const std::string& file_name,
                                  const std::string& format);
  /*!
   ...
   */
  DECORD_DLL virtual void SaveToBinary(dmlc::Stream* stream);
  /*!
   * \brief Get the source code of module, when available.
   * \param format Format of the source code, can be empty by default.
   * \return Possible source code when available.
   */
  DECORD_DLL virtual std::string GetSource(const std::string& format = "");
  /*!
   ...
   */
  DECORD_DLL const PackedFunc* GetFuncFromEnv(const std::string& name);
...
constexpr const char* decord_module_ctx = "__decord_module_ctx";
/*! \brief Global variable to store device module blob */
constexpr const char* decord_dev_mblob = "__decord_dev_mblob";
/*! \brief Number of bytes of device module blob. */
constexpr const char* decord_dev_mblob_nbytes = "__decord_dev_mblob_nbytes";
/*! \brief global function to set device */
constexpr const char* decord_set_device = "__decord_set_device";
/*! \brief Auxiliary counter to global barrier. */
constexpr const char* decord_global_barrier_state = "__decord_global_barrier_state";
/*! \brief Prepare the global barrier before kernels that uses global barrier. */
constexpr const char* decord_prepare_global_barrier = "__decord_prepare_global_barrier";
/*! \brief Placeholder for the module's entry function. */
constexpr const char* decord_module_main = "__decord_main__";
}  // namespace symbol
...
#endif  // DECORD_RUNTIME_MODULE_H_
